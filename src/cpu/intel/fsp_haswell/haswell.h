...
/* The Following bit fields also apply to IA32_PACKAGE_THERM_LIMITS */
#define  THERMAL_STATUS			(1 << 0) /* 1 if PROCHOT# is active */
#define  THERMAL_STATUS_LOG		(1 << 1) /* PROCHOT# asserted since last clear (WC0) */
#define  EXTERNAL_PROCHOT		(1 << 2) /* External assert of PROCHOT# detected */
#define  EXTERNAL_PROCHOT_LOG		(1 << 3) /* External PROCHOT# detected since last clear (WC0) */
#define  CRITICAL_TEMP_STATUS		(1 << 4) /* 1 if above Critical Temperature */
#define  CRITICAL_TEMP_STATUS_LOG	(1 << 5) /* Critical Temperature detected since last clear (WC0) */
#define  THERMAL_THRESH_1_STATUS	(1 << 6) /* Temperature is above Threshold 1 */
#define  THERMAL_THRESH_1_STATUS_LOG	(1 << 7) /* (WC0) */
#define  THERMAL_THRESH_2_STATUS	(1 << 8) /* Temperature is above Threshold 1 */
#define  THERMAL_THRESH_2_STATUS_LOG	(1 << 9) /* (WC0) */
#define  POWER_LIMIT_STATUS		(1 << 10) /* CPU Reduced P-State due to PP0_POWER_LIMIT */
#define  POWER_LIMIT_STATUS_LOG		(1 << 11) /* (WC0) */
#define  DIGITAL_READOUT(ia32_therm_status) ((ia32_therm_status >> 16) & 0x7f)
#define  RESOLUTION(ia32_therm_status) ((ia32_therm_status >> 27) & 0x0f)
#define  DIGITAL_READOUT_VALID		(1 << 31)
#define IA32_PLATFORM_DCA_CAP		0x1f8
#define IA32_MISC_ENABLE		0x1a0
#define MSR_TEMPERATURE_TARGET		0x1a2
#define MSR_MISC_PWR_MGMT		0x1aa
#define  ENH_SPEEDSTEP_COORD_DISABLE	(1 << 0)
#define  LOCK_TM_INTERRUPT		(1 << 22) /* Routes thermal interrupts to all cores */
...
void mainboard_romstage_entry(uint32_t bist, uint32_t stackbase);
