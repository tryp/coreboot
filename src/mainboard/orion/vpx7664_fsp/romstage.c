...
const struct rcba_config_instruction rcba_config[] = {
	 ...
	 * D28IP_P2IP  PCIE   INTA -> PIRQB
	 * D29IP_E1P   EHCI   INTA -> PIRQD
	 * D20IP_XHCI  XHCI   INTA -> PIRQC (MSI)
	 * D31IP_SIP2  SATA2  INTA -> PIRQF (MSI)
	 * D31IP_SIP   SATA   INTA -> PIRQG (MSI)
	 * D31IP_SMIP  SMBUS  INTB -> PIRQC
	 * D31IP_TTIP  THRT   INTC -> PIRQB
	 * D27IP_ZIP   HDA    INTA -> PIRQG (MSI)
	 * D26IP_E2P   EHCI2  INTA -> PIRQD
	 */

	/* Device interrupt pin register (board specific) */
	RCBA_SET_REG_32(D31IP, (INTC << D31IP_TTIP) | (INTA << D31IP_SIP2) |
			(INTB << D31IP_SMIP) | (INTA << D31IP_SIP)),
	RCBA_SET_REG_32(D29IP, (INTA << D29IP_E1P)),
	RCBA_SET_REG_32(D28IP, (INTA << D28IP_P1IP) | (INTB << D28IP_P2IP)),
	...
	RCBA_SET_REG_32(D31IR, DIR_ROUTE(PIRQG, PIRQD, PIRQB, PIRQA)),/* SATA, SMBUS, TTIP */
	RCBA_SET_REG_32(D29IR, DIR_ROUTE(PIRQD, PIRQD, PIRQD, PIRQD)),/* EHCI1 */
	RCBA_SET_REG_32(D28IR, DIR_ROUTE(PIRQA, PIRQB, PIRQC, PIRQD)),/* PCIE */
	RCBA_SET_REG_32(D27IR, DIR_ROUTE(PIRQG, PIRQG, PIRQG, PIRQG)),/* HDA */
	RCBA_SET_REG_32(D26IR, DIR_ROUTE(PIRQD, PIRQD, PIRQD, PIRQD)),/* EHCI2 */
